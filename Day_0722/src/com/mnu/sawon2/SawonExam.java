...
public class SawonExam {
	public static void main(String[] args) {
		...
		SawonDTO sawon = dao.getSawon(sabun, na, gen, gra, time);
		
		dao.wepaProcess(sawon);
	...
	/*	//주간급여(등급에 따른 시급)
		...
		*/	
		...
		System.out.print(sawon.getGenstr() + "\t");
		System.out.print(sawon.getGra() + "\t");
		System.out.print(sawon.getWepay() + "\t");
		System.out.print(sawon.getTime() + "\t");
		System.out.print(sawon.getWemo() + "\n");
